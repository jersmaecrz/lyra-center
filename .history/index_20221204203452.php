            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="normal__breadcrumb__text">
                        ...
                        <div class="enroll"><a href="#Courses"><span><b>Enroll Now</b></span> <i class="fa fa-angle-right"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
  ...
  <div class="row justify-content-md-center">
    ...
    <div class="card mb-2">
        <div class="card-body">
            ...
            <div class="lemony"><a class="enroll"><span>Enroll Course</span> <i class="fa fa-angle-right"></i></a></div>
