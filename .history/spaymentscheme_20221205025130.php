...
<br><br><br>
                ...
                <?php
                    if(isset($_GET['id'])){
                        echo "<a  class='butonesTxt butones' href='sEnroll.php?id=".filter_var($_GET['id'])."' name='btnNext' id='button' >Back</a></tr><br>";
                        echo "<a  class='butonesTxt butones' href='spaymentscheme.php?id=".filter_var($_GET['id'])."' name='btnNext' id='button' >Next</a></tr>";
