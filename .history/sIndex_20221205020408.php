                        ...
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                if(isset($_SESSION['user'])){ ?>
                                    <li class="right"><a href="./logout.php">LOGOUT <i class="fa fa-sign-out" aria-hidden="true"></i></a></li>
                                <?php     
                                }else{?>
                                    <li><a href="./login.php"><i class="fa fa-sign-out" aria-hidden="true"></i>LOG IN</a></li>
...
<br><br><h3 class="d-flex justify-content-around md-10"><b>Courses</h3><br>
  <div class="row justify-content-md-center">
    ...
    <div class="card mb-2">
        <div class="card-body">
            ...
            <h6 class="card-subtitle mb-3 text-muted"><?php echo $row-> crsInstructor ?></h6>
            <h6 class="card-subtitle mb-2 price"><?php echo "₱ ". $row-> crsPrice ?></h6>

            <p class="card-text"><?php echo $row-> crsDesc ?></p>
            <?php
                echo "<div class='enroll'><a href='sEnroll.php?id=".filter_var($row -> crsID)."'>Enroll Course <i class='fa fa-angle-right'></i></a></div>";
            ?>
