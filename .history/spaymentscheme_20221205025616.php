...
<br><br><br>
                ...
                <?php
                    if(isset($_GET['id'])){
                        ...
                        echo "<input type='submit' class='butonesTxt butones' href='spaymentscheme.php?id=".filter_var($_GET['id'])."' name='btnNext' id='button' >Next</input></tr>";
                    }
                    if(isset($_POST['method']) && isset($_POST['bank'])&& isset($_POST['acctN'])){
                        echo $_POST['method'];
                        echo $_POST['bank'];
